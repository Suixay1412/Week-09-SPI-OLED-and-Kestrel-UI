...
ตอบ ตัวอักษร 'H' ใช้ 5 ไบต์เพราะฟอนต์ 5x7 กำหนดความกว้าง 5 คอลัมน์ต่อตัวอักษร แต่ละไบต์คือ 1 คอลัมน์แนวตั้ง โดยแต่ละบิตในไบต์ควบคุมพิกเซล 1 จุดในแนวดิ่งของคอลัมน์นั้น

2. หากเราสลับสายไฟระหว่างขา **D0** และ **D1** จะเกิดผลอย่างไรกับสัญญาณ SPI และหน้าจอจะติดหรือไม่?
ตอบ สลับ D0 กับ D1 จะทำให้สัญญาณนาฬิกาไปตกที่ขาข้อมูลแทน ชิปจะอ่านบิตผิดจังหวะทั้งหมด จอจะไม่ติดหรือแสดงผลรวน ไม่ใช่แค่ภาพเพี้ยนเฉยๆ
